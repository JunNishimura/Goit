...
func GetObject(rootGoitDir string, hash sha.SHA1) (*Object, error) {
	hashString := hash.String()
	objPath := filepath.Join(rootGoitDir, "objects", hashString[:2], hashString[2:])
...
func (o *Object) Write(rootGoitDir string) error {
	buf, err := o.compress()
	if err != nil {
		return err
	}

	dirPath := filepath.Join(rootGoitDir, "objects", o.Hash.String()[:2])
